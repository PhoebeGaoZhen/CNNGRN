...
class CNNGRN():
    def __init__(self, dataX_train, labelY_train,dataX_test1, labelY_test1,dataX_test2, labelY_test2,dataX_test3, labelY_test3,dataX_test4, labelY_test4, number):
        ...
        self.dataX_test3 = dataX_test3
        self.labelY_test3 = labelY_test3
        self.dataX_test4 = dataX_test4
        self.labelY_test4 = labelY_test4
        self.number = number
        # self.test_size = 0.2
        # self.batch_size = 4
        # self.epochs = 200
    ...
    def trainmodel(self):
        ...
        # 创建并训练模型
        self.modelgene = CNNGRN_definedFunc.create_model_gene100()
        ...
        model_names2 = trained_models_path + str(self.number+1) + '_CNNGRN_best_model.h5'
        ...
        score_3 = self.modelgene.predict(self.dataX_test3)
        score_4 = self.modelgene.predict(self.dataX_test4)
        ...
        Recall2, SPE2, Precision2, F11, MCC2, Acc2, aucROC2, AUPR2 = CNNGRN_definedFunc.scores(self.labelY_test2[:, 1],
                                                                                               score_2[:, 1],
                                                                                               th=0.5)
        Recall3, SPE3, Precision3, F13, MCC3, Acc3, aucROC3, AUPR3 = CNNGRN_definedFunc.scores(self.labelY_test3[:, 1],
                                                                                               score_3[:, 1],
                                                                                               th=0.5)
        Recall4, SPE4, Precision4, F14, MCC4, Acc4, aucROC4, AUPR4 = CNNGRN_definedFunc.scores(self.labelY_test4[:, 1],
                                                                                               score_4[:, 1],
                                                                                           th=0.5)

        allAUC = [aucROCt,aucROC1,aucROC2,aucROC3,aucROC4]
...
if __name__ == '__main__':
    ...
    for i in range(10):
        ...
        modelgene = CNNGRN(dataX5, labelY5, dataX1, labelY1, dataX2, labelY2, dataX3, labelY3, dataX4, labelY4,i)
    ...
    print(multi_allAUC)
    pd.DataFrame(multi_allAUC).to_csv('net1_2_allAUC_save_07222.csv')
